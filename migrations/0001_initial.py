...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_jcarousellite_sliderimage', (
        ...
        db.send_create_signal('cmsplugin_jcarousellite', ['SliderImage'])

        # Adding model 'SliderAlbum'
        db.create_table('cmsplugin_jcarousellite_slideralbum', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('cmsplugin_jcarousellite', ['SliderAlbum'])

        # Adding M2M table for field images on 'SliderAlbum'
        db.create_table('cmsplugin_jcarousellite_slideralbum_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('slideralbum', models.ForeignKey(orm['cmsplugin_jcarousellite.slideralbum'], null=False)),
            ('sliderimage', models.ForeignKey(orm['cmsplugin_jcarousellite.sliderimage'], null=False))
        ))
        db.create_unique('cmsplugin_jcarousellite_slideralbum_images', ['slideralbum_id', 'sliderimage_id'])

        # Adding model 'SliderPlugin'
        db.create_table('cmsplugin_sliderplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_jcarousellite.SliderAlbum'])),
        ))
        db.send_create_signal('cmsplugin_jcarousellite', ['SliderPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'SliderImage'
        db.delete_table('cmsplugin_jcarousellite_sliderimage')

        # Deleting model 'SliderAlbum'
        db.delete_table('cmsplugin_jcarousellite_slideralbum')

        # Removing M2M table for field images on 'SliderAlbum'
        db.delete_table('cmsplugin_jcarousellite_slideralbum_images')
